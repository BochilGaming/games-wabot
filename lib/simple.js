...
`.trim()
    ...
    */
    ...
    async sendButton(jid, content, footer, buffer = null, button = [], options = {}) {
      ...
      const buttonMessage = {}
      if (buffer && (options.location || options.loc || options.locationMessage)) buttonMessage.locationMessage = { jpegThumbnail: buffer }
      buttonMessage = {
        ...buttonMessage,
        contentText: content,
        footerText: footer,
      ...
      if (buffer && !(options.location || options.loc || options.locationMessage)) {
